  ...
  return (
    <main className="">
      ...
      <div className="flex flex-col px-80 justify-center items-center gap-6">
        <h1 className="seccolor font-bold text-2xl py-3">Design</h1>
      </div>
      ...
      <div className="flex flex-col px-80 justify-center items-center gap-6">
        <h1 className="seccolor flex flex-col items-center font-bold text-2xl py-3">Desenvolvimento de Software</h1>
      </div>
      <section className="flex flex-col px-80 justify-center items-center gap-6">
        <div className="border-2 w-[700px] rounded-lg">
          <div className="flex flex-col p-10">
